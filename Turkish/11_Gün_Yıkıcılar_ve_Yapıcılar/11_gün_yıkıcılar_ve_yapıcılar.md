...
Dizideki tüm elemanlara değişken atanmayabilir. İlkinin birkaçını yok edip ve kalanını yapıcı operatörünü (...) kullanarak dizi olarak alabiliriz.
...
// person nesnesi hakkında yıkım kullanmayarak bilgi veren bir fonksiyon oluşturalım
...
```js
// person nesnesi hakkında yıkım kullanarak bilgi veren bir fonksiyon oluşturalım
const getPersonInfo = ({
  firstName,
  lastName,
  age,
...
1. E, pi, yerçekimi, humanBodyTemp, waterBoilingTemp sabitleri dizisinin öğelerini yıkım işlemi uygulayın ve atayın.
2. fin, est, sw, den veya nor olarak ülkeler dizisinin öğelerini yıkım işlemi uygulayın ve atayın.
3. Dikdörtgen nesnesini özelliklerine veya anahtarlarına göre yıkım işlemi uygulayın.

### Egzersiz: Seviye 2

1. Kullanıcılar dizisini Iterator ve yıkım kullanarak nesnenin tüm anahtarlarını alın.
2. İkiden az beceriye sahip kişileri bulun.

### Egzersiz: Seviye 3

1. Tüm ülkelerin adını, sermayesini, nüfusunu ve dillerini yazdıran ülkeler nesnesine yıkım işlemi uygulayın
2. Küçük bir geliştirici, öğrenci adını, becerilerini ve puanını okunması kolay olmayabilecek diziler halinde yapılandırır.Aşağıdaki dizi adını ada, beceriler dizisini becerilere, puan dizisini puanlara, JavaScript puanını jsScore'a ve React puanını React değişkenine tek bir satırda yıkım işlemi uygulayın.
